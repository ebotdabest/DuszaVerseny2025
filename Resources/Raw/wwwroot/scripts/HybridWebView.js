// Standard HybridWebView JavaScript library
window.HybridWebView = {
        ...
        "InvokeDotNet": async function InvokeDotNetAsync(methodName, paramValues) {
                const body = { MethodName: methodName };
        ...
        "__TriggerAsyncFailedCallback": function __TriggerAsyncCallback(taskId, error) {
                var json;
                if (!error) {
                        json = { Message: "Unknown error", StackTrace: Error().stack };
                } else if (error instanceof Error) {
                        json = { Name: error.name, Message: error.message, StackTrace: error.stack };
                } else if (typeof (error) === 'string') {
                        json = { Message: error, StackTrace: Error().stack };
                } else {
                        json = { Message: JSON.stringify(error), StackTrace: Error().stack };
                }
